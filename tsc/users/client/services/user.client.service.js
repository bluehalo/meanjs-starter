            ...
            AuthenticationService = (function () {
                ...
                AuthenticationService.prototype.login = function (user) {
                    ...
                    this._http.post('auth/signin', JSON.stringify(user), {
                        ...
                        .subscribe(function (data) { return _this.saveLogin(data); }, function (err) { return _this.logError(err); }, function () { return _this.completeLogin(); });
                };
                AuthenticationService.prototype.saveLogin = function (loginData) {
                    console.log(loginData);
                    localStorage.setItem("user", loginData);
                };
                AuthenticationService.prototype.completeLogin = function () {
