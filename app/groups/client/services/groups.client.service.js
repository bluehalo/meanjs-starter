...
angular.module('asymmetrik.groups').service('groupService', ['$http', '$q', '$log', 'authService', 'Authentication',
	function ($http, $q, $log, authService, Authentication) {
		...
		return ({
			...
			roles: [
				{ label: 'Group Admin', description: 'This user can manage the membership and metadata of the group', role: 'admin' },
				{ label: 'Subscription Editor', description: 'This user can create/edit/delete subscriptions within this group', role: 'editor' }
			],
