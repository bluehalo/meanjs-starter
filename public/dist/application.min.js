...
"use strict";angular.module("asymmetrik.reports").config(["$stateProvider",function($stateProvider){$stateProvider.state("report",{"abstract":!0,template:"<ui-view/>"}).state("report.list",{url:"/reports",templateUrl:"app/reports/views/list-reports.client.view.html",controller:"ListReportsController",data:{roles:["user"]}}).state("report.create",{url:"/report/create",templateUrl:"app/reports/views/manage-report.client.view.html",controller:"ManageReportController",data:{roles:["user"],mode:"create"}}).state("report.edit",{url:"/report:reportId/edit",templateUrl:"app/reports/views/manage-report.client.view.html",controller:"ManageReportController",data:{roles:["user"],mode:"edit"},resolve:{Groups:["groupService",function(groupService){return groupService.list()}]}}).state("report.view",{url:"/report:reportId",templateUrl:"app/reports/views/view-report.client.view.html",controller:"ViewReportController",data:{requiresAuthentication:!1}})}]);
